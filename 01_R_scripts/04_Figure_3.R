# Updates v02: direction of comparison is changed
# Updates v02: DEG export
# Updates v03: Table DEG for publication
# Updates v03: Enzyme "Chymotrypsin-2-like"
...
# Exclude males and females blood-fed
metadata <- metadata[metadata$sex != "Male", ]
metadata <- metadata[metadata$diet != "Bloodfed",]

# Exclude D4, because sample was degradated (did not pass QC)
...
highlight_genes1 <- c("XP_314094", "XP_061505648", "XP_311486", "XP_314095", "XP_061500553",   
                      "XP_320163", "XP_309021", "XP_308427", "XP_319801", "XP_061512210")       
...
# List of genes to highlight
highlight_genes2 <- c("XP_320163", "XP_061512995", "XP_001237817", "XP_061512599", "XP_319801",    
                      "XP_061505648", "XP_314094","XP_314095", "XP_061497682", "XP_061513057")       
...
# List of genes to highlight
highlight_genes3 <- c("XP_309133", "XP_003435746", "XP_003436891", "XP_316419", "XP_061512281",       
                      "XP_311486","XP_061500553","XP_317172","XP_317174", "XP_319956")                         
...
sig_genes2 <- res2[res1$padj < 0.05 & abs(res2$log2FoldChange) > 0.58, ]
sig_genes3 <- res3[res1$padj < 0.05 & abs(res3$log2FoldChange) > 0.58, ]
...
# Create heatmap without gene names (for more attractive visualization)

# Create a heatmap
heatmap_plot2 <- pheatmap(sig_gene_counts,
                          cluster_rows = TRUE,
                          cluster_cols = TRUE,
                          show_rownames = TRUE,
                          show_colnames = TRUE,
