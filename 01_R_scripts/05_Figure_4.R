...
metadata <- metadata[metadata$diet != "Sugarfed",]
# Exclude D4, because sample was degradated
...
# Label genotypes
#metadata3$genotype <- factor(metadata3$genotype, 
#                            levels = c("WT", "GD", "KO"),
#                            labels = c("AngG3", "AgNosCd-1", "Agcd-deletion11"))
...
highlight_genes1 <- c("XP_311486", "XP_316401", "XP_001231076", "XP_061500553", "XP_001231036",
                      "XP_001238571", "XP_320163", "XP_061496484", "XP_317081")
...
# List of genes to highlight
highlight_genes2 <- c("XP_061512995", "XP_320163", "XP_061514976", "XP_061496484", "XP_312110",
                      "XP_309133", "XP_061514174", "XP_001238365", "XP_061513480", "XP_061512353")

# Create a new column to indicate if the gene should be highlighted
res2$delabel2 <- ifelse(res2$refseq %in% highlight_genes2, res2$name, NA)
...
p3a <- ggplot(data=res3, aes(x=log2FoldChange, 
  ...
  ylim(0,150) +
  xlim(-15,15) +
  ggtitle("AgNosCd1 vs Agcd-deletion11") +
  xlab("Log2 Fold Change") + ylab("-Log10 p-value") +
  theme(legend.position = "bottom", legend.box = "vertical")
...
highlight_genes3 <- c("XP_311486", "XP_061512995", "XP_061500553", "XP_061505432", "XP_001231036",
                      "XP_001238571", "XP_557821", "XP_061514246", "XP_001238133")

# Create a new column to indicate if the gene should be highlighted
res3$delabel2 <- ifelse(res3$refseq %in% highlight_genes3, res3$name, NA)
...
heatmap_plot <- pheatmap(sig_gene_counts,
                         ...
                         annotation_legend_param = list(text = list(size = 8)))
